...
import { determineTimeframe, TimeframeType } from '../../../utils/determineTimeframe';
...
const BtcChart:FC<PropsWithChildren<IBtcChart>> = ({timeframe, btcDayQuery, btc3DayQuery, btc7DayQuery, btcMonthQuery}) => {
                ...
                <Line
                    data={{
                        labels: determineTimeframe(
                            ...
                            btc3DayQuery.prices,
                            btc7DayQuery.prices,
                            btcMonthQuery.prices).map((el:number[]) => {
                        ...
                        datasets: [{
                            ...
                            data: determineTimeframe(
                              ...
                              btc3DayQuery.prices,
                              btc7DayQuery.prices,
                              btcMonthQuery.prices).map((el:number[]) => el[1]), 
                            borderColor:'#93f2e4',
